  ...
  <div class="top-header">
    <div class="container">
      ...
      <div class="header-navs">
        <ul class="navs">
          <li class="nav" v-for="item in navs">
            <template v-if="item.type">
              <a href="javascript:viod(0);" class="nav-item"
      ...
      <div class="header-search" :class="{'search-active':hotStatus}">
        <ul class="hot-word" v-show="!hotStatus" transition="fadeOut">
          <li class="hot-item" v-for="item in hotItems">
            {{item}}
          </li>
        </ul>
        <input
          @focus="evtIptFocus"
          @blur="evtIptBlur" class="search-ipt" name="search" type="search">
        <label class="search-btn" for="search">
          <i class="icon-search"></i>
        </label>
        <ul class="search-result clearfix" v-show="hotStatus">
    ...
    <div class="header-menu"
      ...
      @mouseleave="evtHeaderLeave()" transition="fadein" v-show="headerStatus">
