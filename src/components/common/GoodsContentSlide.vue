<template>
  <div class="content" :class="content.type">
    ...
    <div class="slide-wrap">
      <span @click="slidePre($index)" class="slide-pre">
        <i class="fa fa-chevron-left fa-fw icon-chevron-left"></i>
      </span>
      <span @click="slideNext($index)" class="slide-next">
      ...
      <ul class="dot-list">
        <li class="dot-item" v-for="item in 4" :class="{'active': this.currPage === $index}">
          <span class="dot"></span>
        </li>
      </ul>
    </div>
